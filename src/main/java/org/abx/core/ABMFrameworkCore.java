...
import org.abx.core.bag.BagUtils;
import org.abx.core.data.NormalGenerator;
import org.abx.core.framework.GridJava;
import org.abx.core.img.ImgClient;
import org.abx.core.math.Complex;
...
public class ABMFrameworkCore implements ABMListener {
    ...
    public ABMFrameworkCore(OptimizationLevel optimizationLevel) throws Exception {
        ...
        cx.leave();
        processResource("org/abx/core/set/BagWrapper.js");
        processResource("org/abx/core/set/SetWrapper.js");
        processResource("org/abx/core/set/ListWrapper.js");
        processResource("org/abx/core/utils/Utils.js");
        processResource("org/abx/core/utils/Tests.js");
        cx.enter();
        SyntaxUtil.setup(cx);
        cx.leave();
        processResource("org/abx/core/utils/Globals.js");
        processResource("org/abx/core/units/UnitSystem.js");
        processResource("org/abx/core/units/Distance.js");
        processResource("org/abx/core/units/Angle.js");
        processResource("org/abx/core/units/Time.js");
        processResource("org/abx/core/math/ComplexWrapper.js");
        processResource("org/abx/core/framework/ABMPen.js");
        processResource("org/abx/core/framework/ABMEntity.js");
        processResource("org/abx/core/framework/ABMRelation.js");
        processResource("org/abx/core/framework/ABMPatch.js");
        processResource("org/abx/core/framework/ABMAgent.js");
        processResource("org/abx/core/framework/ABMVertex.js");
        processResource("org/abx/core/framework/ABMEdge.js");
        processResource("org/abx/core/framework/ABMStroke.js");
        processResource("org/abx/core/framework/ABMChartSeries.js");
        processResource("org/abx/core/framework/ABMTimeChart.js");
        processResource("org/abx/core/framework/ABMHistogram.js");
        processResource("org/abx/core/framework/ABMChart.js");
        processResource("org/abx/core/framework/ABMEnv.js");
        processResource("org/abx/core/framework/ABMGrid.js");
